...
// Guarded with function_exists() because this template can be included more than
// once per request if the Tools page is ever rendered via an admin-ajax or
// admin-post callback in addition to the normal admin menu page.

if ( ! function_exists( 'gbp_migrate_old_blocks' ) ) {
	/**
...
if ( ! function_exists( 'gbp_reset_usage_stats' ) ) {
	/**
...
if ( ! function_exists( 'gbp_export_presets' ) ) {
	/**
